package com.t.pausi.autocomplete;
...
//                            ""+constraint.toString().trim().replaceAll(" ","+")+"&location="+"22.7028438"+","+"75.8716298"+"+&radius=20000&types=geocode&sensor=true");
                    ...
                    wo.setUrl("https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDpL4q4IU7hkJ6H9wv-p0CRlW3TRTvG4sQ&input="+constraint.toString().trim().replaceAll(" ","+")+"&location="+lat+","+lon+"+&radius=20000&types=geocode&sensor=true");
                   System.out.println("URL***"+"https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDpL4q4IU7hkJ6H9wv-p0CRlW3TRTvG4sQ&input="+constraint.toString().trim().replaceAll(" ","+")+"&location="+lat+","+lon+"+&radius=20000&types=geocode&sensor=true");
